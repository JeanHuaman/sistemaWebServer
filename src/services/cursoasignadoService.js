...
const getAllCursoAsignadoPorIdUserIdCurso = async (id_usuario,id_curso)=>{
    try {
        const cursosAsignados = await cursoAsignadoData.getAllCursoAsignadoIdUserIdCurso(id_usuario,id_curso)
        const aux = []
...
module.exports ={
    ...
    getAllCursoAsignadoPorIdUserIdCurso,
    postCursoAsignado,
    deleteCursoAsignado
}